 ...
 */
[[nodiscard]] KMAILTESTS_TESTS_EXPORT bool handleClickedURL(
    const QUrl& url,
    const QSharedPointer<MailCommon::FolderSettings>& folder = QSharedPointer<MailCommon::FolderSettings>(),
    const Akonadi::Collection& collection = Akonadi::Collection(), QWidget* parentWidget = nullptr);

[[nodiscard]] KMAILTESTS_TESTS_EXPORT bool
mailingListsHandleURL(const QList<QUrl>& lst, const QSharedPointer<MailCommon::FolderSettings>& folder,
                      const Akonadi::Collection& collection);

[[nodiscard]] KMAILTESTS_TESTS_EXPORT bool mailingListPost(const QSharedPointer<MailCommon::FolderSettings>& fd,
                                                           const Akonadi::Collection& col);
[[nodiscard]] KMAILTESTS_TESTS_EXPORT bool mailingListSubscribe(const QSharedPointer<MailCommon::FolderSettings>& fd,
                                                                const Akonadi::Collection& col);
[[nodiscard]] KMAILTESTS_TESTS_EXPORT bool mailingListUnsubscribe(const QSharedPointer<MailCommon::FolderSettings>& fd,
                                                                  const Akonadi::Collection& col);
[[nodiscard]] KMAILTESTS_TESTS_EXPORT bool mailingListArchives(const QSharedPointer<MailCommon::FolderSettings>& fd,
                                                               const Akonadi::Collection& col);
[[nodiscard]] KMAILTESTS_TESTS_EXPORT bool mailingListHelp(const QSharedPointer<MailCommon::FolderSettings>& fd,
                                                           const Akonadi::Collection& col);
