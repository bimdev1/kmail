...
void ClearCacheJobInFolderAndSubFolderJob::slotFetchCollectionDone(const Akonadi::Collection::List& list)
{
    ...
    if (lst.isEmpty()) {
        ...
        connect(job, &Akonadi::ClearCacheFoldersJob::clearCacheDone, this,
                &ClearCacheJobInFolderAndSubFolderJob::clearCacheDone);
        ...
        // connect(job, &Akonadi::ClearCacheFoldersJob::description, this,
        // &ClearCacheJobInFolderAndSubFolderJob::slotClearAkonadiCacheUpdate);
        connect(item, &KPIM::ProgressItem::progressItemCanceled, this,
                &ClearCacheJobInFolderAndSubFolderJob::slotClearAkonadiCacheCanceled);
        job->start();
    }
}
...
void ClearCacheJobInFolderAndSubFolderJob::slotClearAkonadiCacheUpdate(Akonadi::ClearCacheFoldersJob* job,
