...
RemoveCollectionJob::RemoveCollectionJob(QObject* parent) : QObject(parent) {}
...
void RemoveCollectionJob::slotDelayedRemoveFolder(KJob* job)
{
    ...
    if (KMessageBox::warningContinueCancel(
            mMainWidget, str, title, KGuiItem(buttonLabel, QStringLiteral("edit-delete")), KStandardGuiItem::cancel(),
